  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved lookup as @lookup" do
        ...
        post :create, {:lookup => { "url" => "invalid value" }}, valid_session
        assigns(:lookup).should be_a_new(Lookup)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested lookup" do
        ...
        Lookup.any_instance.should_receive(:update).with({ "url" => "MyString" })
        put :update, {:id => lookup.to_param, :lookup => { "url" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the lookup as @lookup" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Lookup.any_instance.stub(:save).and_return(false)
        put :update, {:id => lookup.to_param, :lookup => { "url" => "invalid value" }}, valid_session
        assigns(:lookup).should eq(lookup)
      end
